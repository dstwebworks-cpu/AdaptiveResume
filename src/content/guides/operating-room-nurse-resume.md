---
title: "Operating Room Nurse Resume: Circulating, Scrubbing, and Counts"
description: "Perioperative nursing hires on specifics: which services you cover, whether you circulate or scrub, and the counts and sterile technique behind every case. Write them in."
seoTitle: "Operating Room Nurse Resume: Skills & Format Guide"
seoDescription: "How to write an operating room nurse resume: CNOR placement, circulating vs scrubbing, counts and sterile technique, plus a bullet bank and example rewrite."
segment: "job-seekers"
audience: "Perioperative RNs — circulators, scrub nurses, and nurses moving into the OR"
keyword: "operating room nurse resume"
giveaway:
  name: "Operating Room Nurse Resume Skeleton"
  file: "/templates/operating-room-nurse-resume-template.docx"
cta:
...
faq:
  - q: "Should I say whether I circulate or scrub?"
    a: "Yes, plainly and per role: 'circulating RN, scrub [share] of cases' or whatever your real split is. Managers staff rooms around that split, so a resume that hides it just forces the question in a phone screen."
  - q: "Does CNOR matter on an operating room resume?"
    a: "It's the specialty's board certification, so if you hold it, it leads your certification block. If you don't, BLS and ACLS listed exactly as held are the baseline; never list CNOR as 'in progress' unless an exam date exists."
  - q: "How do I show my case experience without exaggerating?"
    a: "Name your service lines and your real role in them: 'general and ortho; observed cardiac' is honest and useful. Padding service lines gets exposed on your first assignment, so accuracy is also self-protection."
draft: false
---
...
For the base occupation vocabulary, [O*NET profiles this work under Registered Nurses (29-1141.00)](https://www.onetonline.org/link/summary/29-1141.00) — perioperative nursing is a specialty within the RN occupation rather than a separately coded job, so your case specifics have to say what the code can't.
