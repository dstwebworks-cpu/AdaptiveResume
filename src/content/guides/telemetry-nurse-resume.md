...
draft: false
faq:
  - q: "What distinguishes a telemetry resume from a med-surg one?"
    a: "The monitoring competencies: rhythm interpretation, drip titration, and the acuity between med-surg and ICU. Name the unit size, your ratios, and the drips you actually titrate."
  - q: "Is a PCCN worth listing before I have it?"
    a: "Only what you hold goes in the credentials block. If you're scheduled to sit for it, a clearly separated 'PCCN exam scheduled [month]' line is honest; blending it into held credentials is not."
  - q: "How do I show readiness for ICU or ER moves?"
    a: "Charge shifts, rapid-response involvement, the highest-acuity assignments you take, and cross-training - stated as what happened, not as ambition adjectives."
---
...
The strongest single line on a tele resume describes the unit like a nurse would to another nurse:

**Before:** "Provided nursing care to patients on a telemetry floor."
**After:** "36-bed cardiac telemetry/step-down unit; typical ratio 1:4-5; continuous monitoring with titrated cardiac drips; frequent post-cath and CHF population."

That one sentence answers acuity, scope, and trust level before the reader hits a single bullet.

## Bullets that show tele judgment

The work that separates tele from med-surg is recognition and response — say it concretely: rhythm changes caught and escalated, rapid responses initiated, drips titrated per protocol, charge or preceptor duties, floating to other units (name them — floating is versatility evidence). Volume counts too: admissions/discharges per shift on a high-turnover unit is real workload evidence.
...
List each contract honestly — facility, unit type, weeks — rather than blurring it into one entry. Rapid-onboarding across systems is itself the skill; name the EMRs you charted in (Epic, Cerner, Meditech) because staffing software filters on them.
...
- "Telemetry RN on a [N]-bed unit: typical [N]:1 ratios, [step-down/PCU] acuity"
- "Rhythm interpretation and titration of [cardizem/amiodarone/heparin - the drips you actually run]"
- "ACLS [+ PCCN if held] - exactly as held, with dates"
- "Charge nurse [N] shifts/week; rapid response participation [frequency]"
- "[Epic/Cerner] superuser; precepted [N] new hires to the monitor room and floor"

## What screening software looks for on a telemetry nurse resume

Filters read for: telemetry, progressive care, step-down, cardiac monitoring, rhythm interpretation, drip titration, ACLS, PCCN, charge nurse, preceptor, Epic or Cerner, patient ratios. [O*NET's registered nurse profile](https://www.onetonline.org/link/summary/29-1141.00) covers the base vocabulary; the unit specifics are what tele recruiters actually read for.
